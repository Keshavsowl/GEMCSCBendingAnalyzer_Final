...
# with command line options: step2 --mc -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2025 --conditions auto:phase1_2025_realistic --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUGHLT --geometry DB:Extended --era Run3_2025 --filein file:merged_GEN_SIM.root --fileout file:step2.root --python_filename step2_DIGI_cfg.py --number 1000000 --nThreads 4 --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:merged_GEN_SIM.root'),
